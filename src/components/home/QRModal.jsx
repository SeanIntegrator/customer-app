  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{
          background: 'linear-gradient(148deg, #1e3822 0%, #142012 100%)',
          borderRadius: 28,
      ...
      >
        ...
        <div
          style={{
            position: 'absolute',
            inset: 0,
            backgroundImage: LOYALTY_MODAL_GRAIN,
            pointerEvents: 'none',
            borderRadius: 28,
          }}
        />
        <motion.div
          style={{
            ...
            height: 240,
            borderRadius: '50%',
            background: 'radial-gradient(circle, rgba(200,144,42,0.22) 0%, transparent 65%)',
            pointerEvents: 'none',
          }}
          ...
          >
            <div
              style={{
                ...
                height: 38,
                borderRadius: '50%',
                background: avatarUrl ? 'transparent' : 'linear-gradient(140deg, #c8902a, #deb040)',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
                fontFamily: 'Fraunces, Georgia, serif',
