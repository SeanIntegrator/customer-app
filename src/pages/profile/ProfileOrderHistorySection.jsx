...
import { formatHistoryOrderDate, orderSummaryLine, ORDERS_PAGE_SIZE } from '../../lib/profileUtils';
    ...
    >
      ...
      {!isAuthenticated ? (
        ...
        >
          ...
          >
            When you complete an order, it will show up here.
          </p>
        </div>
      ) : (
        <>
